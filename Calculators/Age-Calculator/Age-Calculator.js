...
function updatetill() {
  ...
  function calculateage() {
    ...
    const ageDifference = currentDatetime - userip;
    const ageDate = new Date(ageDifference);
    const fyear = ageDate.getUTCFullYear() - 1970;
    const fmonth = ageDate.getUTCMonth();
    const fmonth1 = fyear * 12 + fmonth;
