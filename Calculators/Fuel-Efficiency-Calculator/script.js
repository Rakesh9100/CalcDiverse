function calculateFuelEfficiency() {
    ...
    if (isNaN(distance) || isNaN(fuel) || distance < 0 || fuel < 0) {
        resultContainer.innerHTML = 'Invalid input. Please enter non-negative numbers.';
        return;
    }
    ...
    resultContainer.innerHTML = 'Fuel Efficiency: ' + efficiency.toFixed(2) + ' ' + 'Kilometers per litre';
}
