...
| Deficient Number Calculator | Checks if a number is deficient or not. | 
| Depreciation Calculator | Calculates the value of an asset over time using various depreciation methods. | 
| Descriptive Statistics Calculator | Calculates the descriptive statistics for a given data set. | 
| Discount Calculator | Calculates the discounted price of an item based on original price and discount percentage. | 
| Divisibility Calculator | Calculates the divisibility of a number by another number. | 
| Dividend Calculator | Calculates dividends based on the given inputs. | 
| EDD Calculator | Estimates your due date based on your last menstrual period. | 
| EMI Calculator | Calculates the equated monthly installment for loans. | 
| Eccentricity Calculator | Calculates the eccentricity of an ellipse. | 
| Effort Estimation Calculator | Estimates the effort required to complete a software project. | 
| Electrical Conversions Calculator | Converts electrical units between different systems. | 
| Electrical Energy Calculator | Calculates the electrical energy consumed by an appliance. | 
| Exponential Calculator | Calculates the value of an exponential function. | 
| Exponentiation Calculator | Calculates the power of a given base number. | 
