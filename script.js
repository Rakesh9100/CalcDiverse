...
// Define the home page path
var homePagePath = "/index.html"; // Adjust this path as necessary

// Check if the current path matches the home page path
if (currentPath === homePagePath || currentPath === "/" || currentPath === "") {
  // Show the search bar if on the home page
...
input.addEventListener("input", (e) => {
  let search_input_container = document.querySelector(
...
function filterCalculators() {
  ...
  for (i = 0; i < calculators.length; i++) {
    ...
    if (
      calculatorName.toUpperCase().indexOf(filter) > -1 ||
      calculatorDescription.toUpperCase().indexOf(filter) > -1
    ) {
